...
import copy
from PIL import Image
# module for calculating the content loss
...
def run_model():
    ...
    # Loads image from same folder as app.py
    ...
    class ContentLoss(nn.Module):
        ...
        def __init__(self, target,):
            ...
            # we 'detach' the target content from the tree used to dynamically compute the gradient: this is a stated value, not a variable. Otherwise the forward method of the criterion will throw an error.
    ...
    # creating the gram matrix, to be used to calculate the style loss later
    ...
    # define mean and std dev similar to the normalization applied on images that vgg-19 is trained on
    ...
    class Normalization(nn.Module):
        def __init__(self, mean, std):
            ...
            # .view the mean and std to make them [C x 1 x 1] so that they can directly work with image Tensor of shape [B x C x H x W]. B is batch size. C is number of channels. H is height and W is width.
    ...
    # can also use white noise as input image, so uncomment the below line
...
def run_model():
    ...
    save_img(output)
>>>>>>> 8bf17b9355914d3058504c3e04240ad0a2351ae6:Style Transfer/model.py
